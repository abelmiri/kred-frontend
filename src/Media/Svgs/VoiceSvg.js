...
const VoiceSvg = (props) =>
    <svg className={props.className} viewBox="0 0 35 40">
        <path fill="#808080" d="M2.5,0h21.2L35,11.2v26.3c0,1.4-1.1,2.5-2.5,2.5h-30C1.1,40,0,38.9,0,37.5v-35C0,1.1,1.1,0,2.5,0L2.5,0z"/>
        <path fill="#696969" d="M35,11.3h-8.7c-1.4,0-2.5-1.1-2.5-2.5V0L35,11.3z"/>
